      ...
      <div>
        <div className="flex p-4">
          <div className="flex-1 pr-4">
            <input
              className="w-full py-2 px-4 border rounded focus:bg-gray-200"
              type="text"
          ...
          <button
            className="border rounded p-2 px-4 focus:bg-gray-200"
            onClick={() => {
        ...
        <div className="flex p-4">
          <button
            className="w-full py-2 px-4 border rounded text-red-400 focus:bg-gray-200"
            onClick={() => {
              if (
